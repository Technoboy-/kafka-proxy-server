...
public class PushServer {
    ...
    public PushServer(){
        this.serverConfigs = new PushConfigs(true);
        ...
        this.nettyServer = new NettyServer(serverConfigs, consumer);
        this.messageListenerService = new AcknowledgeMessageListenerService(serverConfigs);
